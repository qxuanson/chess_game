...
def main():
    ...
    while running:
        ...
        if not game_over:
            Move.drawmove(screen, game_state, move_log_font)

        if game_state.checkmate:
            game_over = True
            if game_state.white_to_move:
                Move.drawEndGameText(screen, "Black wins by checkmate")
            else:
                Move.drawEndGameText(screen, "White wins by checkmate")

        elif game_state.stalemate:
            game_over = True
            Move.drawEndGameText(screen, "Stalemate")
...
def positionsInChess(screen, game_state, valid_moves, square_selected):
    ...
    animation.highlightSquares(screen, game_state, valid_moves, square_selected)
